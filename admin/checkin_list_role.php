        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <table id="table_checkin_role" class="table table-hover table-sm table-striped">
                                <thead>
                                    <tr>
...
<script>
  $(document).ready(function () {
    $('#table_checkin_role').DataTable({
      "processing": true,
      "serverSide": true,
      "ajax": {
        "url": "fetch_users_checkin_role.php", // ดึงข้อมูลจากไฟล์ fetch_users_checkin.php
        "type": "POST"
      },
      "columns": [
