    ...
    if (isset($_POST['admin_username']) && isset($_POST['admin_password'])) {
        ...
        if ($result->num_rows == 1) {
            ...
            echo "<script>
                Swal.fire({
                    icon: 'success',
                    title: 'เข้าสู่หน้าจัดการข้อมูลสำเร็จ!',
                    showConfirmButton: false,
                    timer: 1000
                }).then(function() {
                    window.location.href = '../admin/index.php'; // เปลี่ยนเส้นทางไปหน้า index.php พร้อมส่ง status ไปด้วย
                });
            </script>";
        } else {
            ...
            echo "<script>
                Swal.fire({
                    ...
                    text: 'กรุณาตรวจสอบ password ของคุณให้ถูกต้อง',
                }).then(function() {
